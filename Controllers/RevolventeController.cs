                ...
                foreach (string file in httpRequest.Files)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            reqFTP = (FtpWebRequest)FtpWebRequest.Create("ftp://65.99.252.110/httpdocs/assets/images/revolvente/" + id);
                        ...
                        FtpWebRequest reqObj = (FtpWebRequest)WebRequest.Create("ftp://65.99.252.110/httpdocs/assets/images/revolvente/" + id + "/" + postedFile.FileName);
