    ...
    public class GaleriaController : ApiController
    {
        ...
        public IEnumerable<Galeria> Get()
        {
            using (steujedo_sindicatoEntities db = new steujedo_sindicatoEntities())
            {
                ...
                return db.Galerias.OrderByDescending(x => x.gal_id).ToList();
        ...
        public HttpResponseMessage Get(int id)
        {
            ...
            {
                db.Configuration.LazyLoadingEnabled = false;
                var galeria = db.Galerias.FirstOrDefault(x => x.gal_id == id);
                if (galeria != null)
                {
        ...
        public HttpResponseMessage Delete(int id)
        {
            ...
            try
            {
                ...
                using (steujedo_sindicatoEntities db = new steujedo_sindicatoEntities())
                {
                    var galeria = db.Galerias.FirstOrDefault(e => e.gal_id == id);
                    if (galeria == null)
                    {
